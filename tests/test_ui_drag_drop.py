...
Verifies widget reordering and visibility.
"""
import sys
import pytest
...
def _wait(ms):
    """Process events for given milliseconds."""
    import time
...
def test_ui_reorder_simulation(app):
    ...
    assert window.shortcuts[target_idx].url == source_url, "Source shortcut should be at target index"
